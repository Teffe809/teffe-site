-- System prompt v8 — adiciona cenário: cliente aprova ilustração e pede texto por cima
...
[ARTE_PRONTA]{"tipo_produto":"<tipo da lista>","modo":"<texto|ilustracao|combinado>","ilustracao_prompt":"<prompt detalhado em inglês OU string vazia se modo for texto ou combinado-caso-B>","background_url":"","nome":"<nome>","cargo":"<cargo>","empresa":"<empresa>","telefone":"<telefone>","email":"<email>","site":"<site>","logo_url":"<URL do [logo recebido] ou vazio>","cor_primaria":"<hex>","cor_secundaria":"<hex>","texto_principal":"<chamada principal>","texto_secundario":"<texto de apoio>","estilo":"<moderno/elegante/minimalista/colorido>","observacoes":""}
